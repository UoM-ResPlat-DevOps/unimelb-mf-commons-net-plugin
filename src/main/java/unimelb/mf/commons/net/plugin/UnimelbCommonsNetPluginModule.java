package unimelb.mf.commons.net.plugin;
...
import unimelb.mf.commons.net.plugin.sink.FTPSink;

public class UnimelbCommonsNetPluginModule implements PluginModule {

    private List<PluginService> _services;

    private FTPSink _ftpSink;

    public UnimelbCommonsNetPluginModule() {
