package unimelb.mf.commons.net.plugin.sink;
...
import unimelb.commons.net.ftp.FTPClient;
import unimelb.commons.net.ftp.FTPClientFactory;
import unimelb.mf.plugin.sink.AbstractDataSink;
import unimelb.mf.plugin.sink.util.OutputPath;

public class FTPSink extends AbstractDataSink {

    public static final String TYPE_NAME = "ftp";
