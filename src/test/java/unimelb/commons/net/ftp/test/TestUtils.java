...
public class TestUtils {
    ...
    public static final String TEST_PROPERTIES_FILE = System.getProperty("user.home")
            + "/.junit-tests/.unimelb-mf-commons-net-plugin-test.properties";
    ...
    static Map<String, String> getTestSettings() throws Throwable {
        ...
        if (properties != null) {
            settings.put("server.host", properties.getProperty("server.host"));
            settings.put("server.port", properties.getProperty("server.port"));
